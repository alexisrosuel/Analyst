...
FenInfoRecherche::FenInfoRecherche(QString &resultat, QString &resultatAffiner, QWidget *parent = 0) : QDialog (parent)
{
    #if defined (linux)
    ...
    creerFenetre(resultat);

    resultatAffinerVrai = resultatAffiner;
}

void FenInfoRecherche::affiner()
{
     #if defined (linux)
        QTextCodec::setCodecForCStrings(QTextCodec::codecForName("UTF-8"));
        QTextCodec::setCodecForTr(QTextCodec::codecForName("UTF-8"));
...
void FenInfoRecherche::afficherTextes()
{
     #if defined (linux)
        QTextCodec::setCodecForCStrings(QTextCodec::codecForName("UTF-8"));
        QTextCodec::setCodecForTr(QTextCodec::codecForName("UTF-8"));
...
void FenInfoRecherche::afficherImages()
{
     #if defined (linux)
        QTextCodec::setCodecForCStrings(QTextCodec::codecForName("UTF-8"));
        QTextCodec::setCodecForTr(QTextCodec::codecForName("UTF-8"));
...
void FenInfoRecherche::afficherMusiques()
{
     #if defined (linux)
        QTextCodec::setCodecForCStrings(QTextCodec::codecForName("UTF-8"));
        QTextCodec::setCodecForTr(QTextCodec::codecForName("UTF-8"));
...
void FenInfoRecherche::afficherVideos()
{
     #if defined (linux)
        QTextCodec::setCodecForCStrings(QTextCodec::codecForName("UTF-8"));
        QTextCodec::setCodecForTr(QTextCodec::codecForName("UTF-8"));
...
void FenInfoRecherche::fonctionOuvrirTousTextes()
{
    ...
    while(termine == 0)
    {
        ...
        if((nomFichier.contains(".txt")) || (nomFichier.contains(".doc", Qt::CaseInsensitive)) || (nomFichier.contains(".pdf", Qt::CaseInsensitive)) || (nomFichier.contains(".postscript", Qt::CaseInsensitive)) || (nomFichier.contains(".html", Qt::CaseInsensitive)) || (nomFichier.contains(".xhtml", Qt::CaseInsensitive)) || (nomFichier.contains(".odt", Qt::CaseInsensitive)) || (nomFichier.contains(".rtf", Qt::CaseInsensitive)))
        {
...
void FenInfoRecherche::fonctionOuvrirToutesImages()
{
     #if defined (linux)
        QTextCodec::setCodecForCStrings(QTextCodec::codecForName("UTF-8"));
        QTextCodec::setCodecForTr(QTextCodec::codecForName("UTF-8"));
...
void FenInfoRecherche::fonctionOuvrirToutesMusiques()
{
     #if defined (linux)
        QTextCodec::setCodecForCStrings(QTextCodec::codecForName("UTF-8"));
        QTextCodec::setCodecForTr(QTextCodec::codecForName("UTF-8"));
...
void FenInfoRecherche::fonctionOuvrirToutesVideos()
{
     #if defined (linux)
        QTextCodec::setCodecForCStrings(QTextCodec::codecForName("UTF-8"));
        QTextCodec::setCodecForTr(QTextCodec::codecForName("UTF-8"));
...
void FenInfoRecherche::creerActions(QString resultatAffiner)
{
    #if defined (linux)
        QTextCodec::setCodecForCStrings(QTextCodec::codecForName("UTF-8"));
        QTextCodec::setCodecForTr(QTextCodec::codecForName("UTF-8"));
...
void FenInfoRecherche::creerStatut()
{
     #if defined (linux)
        QTextCodec::setCodecForCStrings(QTextCodec::codecForName("UTF-8"));
        QTextCodec::setCodecForTr(QTextCodec::codecForName("UTF-8"));
...
void FenInfoRecherche::creerFenetre(QString resultat)
{
     #if defined (linux)
        QTextCodec::setCodecForCStrings(QTextCodec::codecForName("UTF-8"));
        QTextCodec::setCodecForTr(QTextCodec::codecForName("UTF-8"));
...
void FenInfoRecherche::closeEvent(QCloseEvent*)
{
    this->deleteLater();
}
